 ...
 * 品牌
 */
public class AdapterBrandName extends BaseAdapter{
    private List<ModeEntry> modeEntryList;
    private Context ctx;
    public AdapterBrandName(List<ModeEntry> modeEntryList, Context ctx){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.pinpai.setText(modeEntryList.get(position).getBrandName());
        return convertView;
    }
    class Holder{
        TextView pinpai;
